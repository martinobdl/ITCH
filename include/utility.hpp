...
/**
 * Delclaration of default values.
 *
 * @file utility.cpp
 */
 ...
 * @warning Assumes that the machine is little endian and hence the swapping is indeed necessary. Otherwise no swapping is needed. This checks is not performed.
 */
 ...
 *
 * This reads from a char array pointer (C-style) 16 bits and return the swapped correpsonding number
 *
 ...
 *
 * This reads from a char array pointer (C-style) 32 bits and return the swapped correpsonding number
 *
 ...
 *
 * This reads from a char array pointer (C-style) 64 bits and return the swapped correpsonding number
 *
